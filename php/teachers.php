...
$teachers_query = "SELECT id, name, email, department FROM teachers";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['edit_id'])) {
    ...
    if (!in_array($department, $departments)) {
        ...
        $update_query = "UPDATE teachers SET name = ?, email = ?, department = ?";
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="section">
                    ...
                    <?php while ($row = $teachers_result->fetch_assoc()) : ?>
                        <tr>
                            ...
                            <td data-label="Actions">
                                <form method="POST" style="display:inline;" onsubmit="return confirm('Are you sure you want to drop this teacher?');">
            ...
            <?php else : ?>
                <p class="no-applications">No teachers found.</p>
            <?php endif; ?>
            <?php if (isset($error)) : ?>
