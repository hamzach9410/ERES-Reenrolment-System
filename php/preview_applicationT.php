...
// Fetch teacher's department to ensure access control
$sql_teacher = "SELECT department FROM teachers WHERE id = ?";
$stmt_teacher = $conn->prepare($sql_teacher);
$stmt_teacher->bind_param("i", $teacher_id);
$stmt_teacher->execute();
$result_teacher = $stmt_teacher->get_result();
$teacher = $result_teacher->fetch_assoc();
$teacher_department = $teacher['department'] ?? 'Unknown Department';
...
$stmt_application->bind_param("is", $application_id, $teacher_department);
...
<head>
    ...
    <title>Teacher Application Preview</title>
...
<body>
    <div class="container">
        ...
        <br>
        <a href="teacher_dashboard.php" class="btn back-btn"><i class="fas fa-arrow-left"></i> Back to Dashboard</a> <!-- Updated path -->
    </div>
